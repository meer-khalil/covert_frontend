...
const ListingGrid = () => {
  ...
  const [arePropertiesLoading, setArePropertiesLoading] = useState(true);
      ...
      <div className={`md:px-4 flex-1`}>
        {
          <div>
              ...
              <div className="flex md:justify-between items-center flex-wrap gap-3 mb-12">
                <div className=" mb-3 flex-1">
                  <FormControl fullWidth>
                    ...
                    >
                      {["All", "Published", "UnPublished", "Past Deals"].map(
                        (e) => (
            ...
            <div
              className={`grid grid-cols-1 sm:grid-cols-2 gap-12 md:gap-5 ${
                user?.role === "admin" ? "md:gap-y-16" : ""
              } relative`}
            >
              {properties?.length ? (
            ...
            <h3 className=" text-xl font-bold">
              {operation === "Publish" ? (
                <>
                  ...
                  <span className="text-3xl">{bulkData.length}</span> Items
                </>
              ) : operation === "Unpublish" ? (
                <>
