      ...
      >
        ...
        <Box sx={{ display: "flex", gap: 10 }}>
          <Autocomplete
            ...
            renderInput={(params) => (
              <TextField {...params} label="Timeframe for investing" />
            )}
          />
          <Autocomplete
            disablePortal
            ...
            renderInput={(params) => (
              <TextField {...params} label="Total Capital Available" />
            )}
          />
        </Box>
        ...
        <Box my={5}>
          <Autocomplete
            ...
            renderInput={(params) => (
              <TextField {...params} label="Financing" />
            )}
          />
        </Box>
        ...
        <div className=" mt-3 pl-2">
          <FormGroup>
            <FormControlLabel
              ...
              label={
                "I agree with Off Market Finds Terms and Privacy Policy and I have read and understand  then agency relationship."
              }
            />
          </FormGroup>
        </div>
