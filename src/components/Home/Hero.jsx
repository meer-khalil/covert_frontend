    ...
    >
      <div className=" flex justify-center items-center flex-col max-w-[1440px]">
        ...
        <Box>
          ...
          <label class="relative text-gray-400 focus-within:text-gray-600 block bg-red-400 max-w-[524px] md:w-[524px] my-[25px] md:my-[50px] rounded-lg md:rounded-xl overflow-hidden">
