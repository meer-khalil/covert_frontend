...
const MortgageCalculator = ({ price, setDownPaymentCashFlow }) => {
  ...
  const { setMortgage, downPayment, setDownPayment } =
              ...
              <div className="flex flex-1 gap-2 items-center">
                ...
                <div class="relative inline-block w-10 align-middle select-none">
                  <input
                    ...
                    id="switch"
                    name="switch"
                    class={`toggle-checkbox absolute ${
                      dollarPer ? "" : "right-0"
                    } block w-5 h-5 rounded-full bg-blue-500 border-4 appearance-none cursor-pointer`}
                    onChange={() => {
                  ...
                  <label
                    for="switch"
                    class="toggle-label block overflow-hidden h-5 rounded-full bg-white border-2 border-blue-400 cursor-pointer"
                  ></label>
                </div>

                <span className="font-opensans text-xl">%</span>
              </div>
              <p className="flex-1 text-end font-opensans text-xl">
                ${loanPayment}
              </p>
            </div>
          </div>
